...
/**
 * createAccount : 사용자가 있는지 조회, 계죄 번호 생성, 생성한 계좌를 db에 저장, 그 정보를 넘김
 * <p>
 * map(lambda) : stream에 있는 값들에 전부 lambda 적용
 * <p>
 * account -> (Integer.parseInt(account.getAccountNumber())) + 1 + ""
 * ==> 계좌번호를 정수로 바꾸고 1을 더한 다음 ""을 더해서 문자열로 변환
 * <p>
 * fromEntity : 생성된 entity를 dto로 변환해서 반환
 */
@Service
